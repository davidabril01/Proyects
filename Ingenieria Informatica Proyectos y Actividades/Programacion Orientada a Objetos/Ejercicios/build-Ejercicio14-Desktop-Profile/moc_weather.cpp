...
QT_MOC_LITERAL(1, 8, 23), // "signal_temperaturaLista"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 11), // "ConectarApi"
QT_MOC_LITERAL(4, 45, 14), // "QNetworkReply*"
QT_MOC_LITERAL(5, 60, 5) // "reply"

    },
    "Weather\0signal_temperaturaLista\0\0"
    "ConectarApi\0QNetworkReply*\0reply"
};
...
void Weather::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_temperaturaLista((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->ConectarApi((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Weather::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Weather::signal_temperaturaLista)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Weather::signal_temperaturaLista(QString _t1)
{
