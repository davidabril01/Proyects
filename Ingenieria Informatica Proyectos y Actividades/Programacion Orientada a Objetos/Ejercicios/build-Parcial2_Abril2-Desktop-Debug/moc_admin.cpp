...
#include <memory>
#include "../Parcial2_Abril2/admin.h"
...
QT_MOC_LITERAL(1, 6, 17), // "onUsuarioValidado"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7) // "usuario"

    },
    "Admin\0onUsuarioValidado\0\0usuario"
};
...
void Admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onUsuarioValidado((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
