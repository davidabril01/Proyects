        ...
        <div className="SignIn_layout">
            <div className="layout__box">
                <main className="layout__content">
                    <h2 className="content__title">Sign<span className="title__color">In</span></h2>
                    <div className="content__sign-in">Already Have An Account? <a className="sign-up__link" href="#" onClick={toggleLayout}>Sign Up</a></div>
                    <div className="content__principal">
                        <div className="content__user-info">
                            <div className="user-info__first-name">
                                <div className="first-name__label">Frist Name</div>
                                <div className="first-name__input">
                                    <input className="input__text" type="text"></input>
                                </div>
                            </div>
                            <div className="user-info__last-name">
                                <div className="last-name__label">Last Name</div>
                                <div className="last-name__input">
                                    <input className="input__text" type="text"></input>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="content__secondary">
                        ...
                        <div className="content__or-span">Or</div>
